	    ...
	    if ( $this->data['delivery_type']=="delivery"){
	    	if (FunctionsV3::isSearchByLocation()){	    		
	    		...
	    		try {
	    			...
	    			$lat = isset($this->data['map_accurate_address_lat'])?$this->data['map_accurate_address_lat']:0;
	    			$lng = isset($this->data['map_accurate_address_lng'])?$this->data['map_accurate_address_lng']:0;
