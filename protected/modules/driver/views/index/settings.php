    ...
    <form id="frm" class="frm form-horizontal">
	 ...
	 <div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-6">	     
	     <?php echo CHtml::textField('api_link',websiteUrl()."/driver/api",array(
	 ...
	 <div class="form-group">
	  ...
	  <h4 style="font-weight:600;"><?php echo Driver::t("Order Settings")?></h4>	
	    ...
	    $drv_order_status = getOptionA('drv_order_status');	    
	    if($json_status = json_decode($drv_order_status,true) ){
	    	$drv_order_status = $json_status;
	    } else {
	    	$drv_order_status = array($drv_order_status);
	    }
	    
	    unset($order_status_list[0]);	   	    
	     
	     echo CHtml::dropDownList('drv_order_status',
	    (array)$drv_order_status,
 ...
 <div class="form-group">
	 ...
	 <div class="form-group">
	    ...
	    <div class="col-sm-2">
	      ...
	      ?>	
	      <p class="text-muted top5"><?php echo Driver::t("in seconds, Default is 60 seconds")?></p>	            
	    </div>
	  </div>	     
    ...
    <li> <!--FCM-->
     <div class="inner">
      ...
      $this->renderPartial('/index/fcm_settings',array(
        'services_json_account'=>getOptionA('drv_services_json_account')
      ));
      ?>
     </div>
    </li> <!--END FCM-->
    ...
    <li>
     ...
     <p>
     <a href="<?php echo Yii::app()->getBaseUrl(true)."/driver/cron/processautoassign_all"?>" target="_blank">
     <?php echo Yii::app()->getBaseUrl(true)."/driver/cron/processautoassign_all"?>
     </a>
     </p>
     
     <p>
     <a href="<?php echo Yii::app()->getBaseUrl(true)."/driver/cron/processautoassign_onebyone"?>" target="_blank">
     <?php echo Yii::app()->getBaseUrl(true)."/driver/cron/processautoassign_onebyone"?>
     </a>
     </p>
