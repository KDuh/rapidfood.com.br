...
class IndexController extends CController
{
	...
	{			
	    ...
	    /*1.8.0 UPDATE*/
	    if( !DatataseMigration::checkFields("{{driver_bulk_push}}",array('fcm_response')) ){
	    	$this->redirect(Yii::app()->createUrl(APP_FOLDER.'/update'));
			Yii::app()->end();
	    }
	    
	    /*1.8.1 UPDATE*/
	    if( !DatataseMigration::checkFields("{{client}}",array('payment_customer_type')) ){
	    	$this->redirect(Yii::app()->createUrl(APP_FOLDER.'/update'));
			Yii::app()->end();
	    }
	...
	public function actionIndex(){
		...
		$this->pageTitle = Driver::t("Dashboard");
