 ...
 *   Last Update : 1.7.2 - Mar 01, 2019
 *   Last Update : 1.7.3 - April 16, 2019
 *   Last Update : 1.8.0 - August 8, 2020 
 *   Last Update : 1.8.1 - August 9, 2020
 */

define("APP_FOLDER",'driver');
define("APP_BTN",'btn-raised btn-info');
define("APP_BTN2",'btn-raised');
define("CHANNEL_ID",'kmrs_driver');
define("CHANNEL_TOPIC",'/topics/new_task_');
define("CHANNEL_TOPIC_ALERT",'/topics/driver_alert_');
...
class DriverModule extends CWebModule
{
	...
	public function init()
	{
		...
		Yii::app()->clientScript->registerScriptFile(
        Yii::app()->baseUrl . '/protected/modules/driver/assets/raty/jquery.raty.js',
		CClientScript::POS_END
		);								
