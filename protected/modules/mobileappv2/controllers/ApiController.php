...
class ApiController extends CController
{
	...
	{			
		...
		$settings['home']=array(
		  ...
		  'mobile2_home_categories'=>getOptionA('mobile2_home_categories')
		);
		...
		$settings['map_auto_identity_location']  = getOptionA('map_auto_identity_location');
		...
		$settings['enabled_operating_hours'] = getOptionA('enabled_operating_hours');
		
		$settings['cart_with_qty'] = getOptionA('mobile2_cart_with_qty');
		$settings['social_share_food'] = getOptionA('mobile2_food_share');
		$settings['home_all_as_list'] = getOptionA('mobile2_home_all_as_list');
		
		$mobile2_home_use_view_all = getOptionA('mobile2_home_use_view_all');
		...
		$settings['app_rating'] = array(
		  'enabled'=>getOptionA('mobileapp2_enabled_app_rating'),
		  'email'=>getOptionA('mobileapp2_feedback_email'),
		  'ios_id'=>getOptionA('mobileapp2_app_rating_ios_id'),
		  'android_id'=>getOptionA('mobileapp2_app_rating_android_id'),
		);
